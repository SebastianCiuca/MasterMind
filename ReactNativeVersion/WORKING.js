        ...
        return (
            <View style={styles.containerMain}>
                <ListView
                    ...
                    renderRow={(rowData) => <Row data={rowData} navigation={this.props.navigation} />}
                />
            </View>
        );
    }
    ...
    render() {
        ...
        return (
            <View style={styles.containerElement}>
                ...
                <Button
                    title='Edit Memo'
                    onPress={() => this.props.navigation.navigate('EditMemo', { data: this.props.data.key})}//, navigation: this.props.navigation })}
    ...
    render() {
        return (
            <View style={styles.containerDialog}>
                <Text>{"Insert Memo Title:"}</Text>
                <TextInput
                    onChangeText={(title) => this.setState({title: title})}
                    value={this.state.title}
                />

                <Text>{"Insert Memo Text:"}</Text>
                <TextInput
                ...
                <Button
                    ...
                    onPress={() => { updateItem(this.state);
                        //this.props.navigation.navigate('HomeScreen',{ data: this.props })
